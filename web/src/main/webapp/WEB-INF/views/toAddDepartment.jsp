...
<div class="department">
    <center>
        <form action="${website}/department/addDepartment/${userstatus}/${userId}" method="post">
        ...
        <a href="${website}/department/list/${userstatus}/${userId}" style="font-size:20px;"><button style="margin-top:20px;">取消增加</button></a>
        ${msg}
    </center>
</div>
</body>
