...
<div class="department">
    <center>
        <form action="${website}/department/updateDepartment/${department.id}/${userstatus}" method="post">
        ...
        <a href="${website}/department/list/${userstatus}" style="font-size:20px" ><button style="font-size:20px;margin-top:20px;">取消增加</button></a>
        ${msg}
    </center>
</div>
</body>
